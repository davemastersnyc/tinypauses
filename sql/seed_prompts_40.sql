...
with seed(kind, title, body, step, is_active) as (
  values
    ...
    ('pause', 'One Texture', 'Find something near you to touch and notice if it feels smooth, bumpy, soft, or rough.', 'Run a finger over it slowly for three calm breaths.', true),
    ...
    ('pause', 'Look Far', 'Lift your eyes and find the farthest thing you can see.', 'Rest your eyes there for three slow breaths and let your face soften.', true),
    ...
    ('letting-go', 'Worry Bubble', 'Imagine putting your worry inside a soap bubble.', 'On a long breath out, watch the bubble float up and pop softly into nothing.', true),
    ('letting-go', 'Wave Wash', 'Picture your worry written in the sand at the edge of the sea.', 'Take three breaths and watch a gentle wave wash the words smooth.', true),
    ...
    ('letting-go', 'Paper Boat', 'Picture your worry folded into a little paper boat on a stream.', 'Breathe out slowly three times and watch it drift away and out of sight.', true),
